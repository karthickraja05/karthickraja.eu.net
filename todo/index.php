...
$link = isset($link) ? $link : 'action/userpage.php';
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
				<form class="login100-form validate-form flex-sb flex-w" action="<?php echo $link; ?>" method="post">
					<input type="hidden" name="link" value="userpage.php">
					...
					<div class="wrap-input100 validate-input m-b-36" data-validate = "Username is required">
						<input class="input100" type="text" name="user" value="<?php echo htmlspecialchars($name); ?>">
					...
					<div class="flex-sb-m w-full p-t-55">
						<div>
							<a href="<?php echo $link1; ?>" class="txt3">
